...
def main(args):
    ...
    strategies = [NaiveMovingAverageStrategy(quantity=quantity),
                  OptimizedMovingAverageStrategy(quantity=quantity)
                ]

    StrategyComparator(output_path = "Assignment_3_Results").compare_strategies(
        strategies, 
        parsed_args.cash, 
